...
export class EditEmpModal extends Component{
    ...
    imagesrc = process.env.REACT_APP_PHOTO_URL+this.photofilename;
    ...
    handleFileSelected(event){
        ...
        .then(res=>res.json())
        .then((result)=>{
            this.imagesrc=process.env.REACT_APP_PHOTO_URL+result;
        },
        (error)=>{
            alert('Failed');
        })
    ...
    <Modal.Body>
        ...
        <Row>
            ...
            <Col sm={6}>
                ...
                src={process.env.REACT_APP_PHOTO_URL+this.props.photofilename}
                />
